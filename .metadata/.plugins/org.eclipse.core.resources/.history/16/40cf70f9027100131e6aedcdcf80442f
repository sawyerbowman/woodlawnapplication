 ...
 */
?>
<form method=post action="http://us.1.p10.webhosting.yahoo.com/forms?login=dwayneb">
...
<img src="Images/Application_Header.png" alt="Application_Header" width="640.5" height="163.5">
...
echo('<input type="Radio" id="schooltype" name="schooltype" value="Public"> Public ');
echo('<input type="Radio" id="schooltype" name="schooltype" value="Private"> Private');
...
<p>Guardian 1:<span style="font-size:x-small;color:FF0000"></span><input type="text" size="30">
 Relationship to Applicant:<span style="font-size:x-small;color:FF0000"></span><input type="text" size="30"
...
<fieldset>
	<legend>Guardian 1 Contact Information:</legend>
		<table>
			<tr><td>Email:<span style="font-size:x-small;color:FF0000"></span></td> <td><input type="text" size="40"
			...
			<td>Occupation:<span style="font-size:x-small;color:FF0000"></span></td> <td><input type="text" size="30"
